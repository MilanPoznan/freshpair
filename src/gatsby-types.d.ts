...
type pageByIDQuery = { readonly allWpMenu: { readonly menus: ReadonlyArray<{ readonly locations: ReadonlyArray<WpMenuLocationEnum | null> | null, readonly name: string | null, readonly slug: string | null, readonly menuItems: { readonly nodes: ReadonlyArray<{ readonly cssClasses: ReadonlyArray<string | null> | null, readonly databaseId: number, readonly label: string | null, readonly parentDatabaseId: number | null, readonly parentId: string | null, readonly path: string | null, readonly childItems: { readonly nodes: ReadonlyArray<{ readonly cssClasses: ReadonlyArray<string | null> | null, readonly databaseId: number, readonly label: string | null, readonly parentDatabaseId: number | null, readonly parentId: string | null, readonly path: string | null, readonly order: number | null, readonly childItems: { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly cssClasses: ReadonlyArray<string | null> | null, readonly label: string | null, readonly parentDatabaseId: number | null, readonly parentId: string | null, readonly path: string | null } | null> | null } | null } | null> | null } | null } | null> | null } | null }> }, readonly wpPage: { readonly title: string | null, readonly slug: string | null, readonly uri: string | null, readonly homepage: { readonly aboutUs: string | null, readonly bestSellers: ReadonlyArray<{ readonly bestSeller: { readonly id: string, readonly title: string | null } | null } | null> | null, readonly categoryGroup: { readonly categoryLink: string | null, readonly categoryTitle1: string | null, readonly categoryLink2: string | null, readonly categoryTitle2: string | null, readonly categoryLink3: string | null, readonly categoryTitle3: string | null, readonly categoryImage: { readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly categoryImage2: { readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly categoryImage3: { readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } | null } | null } | null };
